...
class ControllerVendorLtsSeo extends Controller {
	...
	public function add() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_vendor_lts_seo->addSeoUrl($this->request->post);
			...
			$this->response->redirect($this->url->link('vendor/lts_seo', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_vendor_lts_seo->editSeoUrl($this->request->get['seo_url_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $seo_url_id) {
				$this->model_vendor_lts_seo->deleteSeoUrl($seo_url_id);
			}
	...
	protected function getList() {
		...
		$seo_url_total = $this->model_vendor_lts_seo->getTotalSeoUrls($filter_data);

		$results = $this->model_vendor_lts_seo->getSeoUrls($filter_data);
		...
		$data['sort_store'] = $this->url->link('vendor/lts_seo', 'user_token=' . $this->session->data['user_token'] . '&sort=store' . $url, true);
		$data['sort_language'] = $this->url->link('vendor/lts_seo', 'user_token=' . $this->session->data['user_token'] . '&sort=language' . $url, true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['seo_url_id'])) {
			$data['action'] = $this->url->link('vendor/lts_seo/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('vendor/lts_seo/edit', 'user_token=' . $this->session->data['user_token'] . '&seo_url_id=' . $this->request->get['seo_url_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/lts_seo', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['seo_url_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$seo_url_info = $this->model_vendor_lts_seo->getSeoUrl($this->request->get['seo_url_id']);
		}
	...
	protected function validateForm() {
		...
		$seo_urls = $this->model_vendor_lts_seo->getSeoUrlsByKeyword($this->request->post['keyword']);
