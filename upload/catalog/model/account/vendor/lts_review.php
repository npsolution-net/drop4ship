...
class ModelAccountVendorLtsReview extends Model {
	public function addReview($vendor_id, $data) {
		...
		$this->db->query("INSERT INTO ". DB_PREFIX ."lts_review SET review_id= '". (int)$review_id ."', product_id = '". (int)$data['product_id'] ."', vendor_id='". (int)$vendor_id ."'");
	...
	public function editReview($review_id, $vendor_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "lts_review SET review_id= '". (int)$review_id ."', product_id = '". (int)$data['product_id'] ."' WHERE review_id = '". (int)$review_id ."' AND vendor_id='". (int)$data['vendor_id'] ."' ");
