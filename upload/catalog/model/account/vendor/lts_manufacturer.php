<?php
class ModelAccountVendorLtsManufacturer extends Model {
	public function addManufacturer($vendor_id, $data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "'");

		$manufacturer_id = $this->db->getLastId();


		$this->db->query("INSERT INTO " . DB_PREFIX . "lts_manufacturer SET manufacturer_id = '" . (int)$manufacturer_id . "', vendor_id = '" . (int)$vendor_id . "'");
	...
	public function editManufacturer($manufacturer_id, $vendor_id, $data) {
	...
	public function deleteManufacturer($manufacturer_id, $vendor_id) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "lts_manufacturer` WHERE manufacturer_id = '" . (int)$manufacturer_id . "' AND vendor_id = '" . (int)$vendor_id . "'");
	...
	public function getManufacturers($data = array()) {
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "lts_manufacturer lm LEFT JOIN " . DB_PREFIX . "manufacturer m ON(lm.manufacturer_id = m.manufacturer_id) WHERE lm.vendor_id = '" . $data['vendor_id'] . "'";
	...
	public function getTotalManufacturers($data = array()) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "lts_manufacturer WHERE vendor_id ='" . (int)$data['vendor_id'] . "'");
