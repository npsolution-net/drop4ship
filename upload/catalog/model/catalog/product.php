...
class ModelCatalogProduct extends Model {
	...
	public function getLatestProducts($data = array()) {
		...
		$sql = $sql . "ORDER BY p.date_added DESC LIMIT " . (int)$data['limit'];
	...
	public function getVendor($product_id){
		return $this->db->query("SELECT v.vendor_id, v.customer_id, c.customer_group_id FROM " . DB_PREFIX . 'lts_product p LEFT JOIN '. DB_PREFIX . 'lts_vendor v ON p.vendor_id = v.vendor_id LEFT JOIN ' . DB_PREFIX . 'customer c ON v.customer_id = c.customer_id WHERE p.product_id = "' . $product_id . '"')->rows;
	}
