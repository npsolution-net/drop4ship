...
$(document).ready(function() {
	...
	$(document).on('click', 'a[data-toggle=\'image\']', function(e) {
		...
		$element.popover({
			...
			trigger: 'manual',
			content: function() {
				return '<button type="button" id="vendor-image" class="btn btn-primary"><i class="fa fa-pencil"></i></button> <button type="button" id="button-clear" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>';
			}
		});
