...
class ControllerAccountVendorLtsCategory extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_account_vendor_lts_category->addCategory($vendor_info['vendor_id'], $this->request->post);
      ...
      $this->response->redirect($this->url->link('account/vendor/lts_category'));
    }
  ...
  public function edit() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
       $this->model_account_vendor_lts_category->editCategory($this->request->get['category_id'], $vendor_info['vendor_id'], $this->request->post);
   ...
   if(!$vendor_info) {
    ...
    if (isset($this->request->post['selected'])) {
      foreach ($this->request->post['selected'] as $category_id) {
        $this->model_account_vendor_lts_category->deleteCategory($category_id);
      }
  ...
  protected function getList() {
    ...
    $data['breadcrumbs'][] = array(
        ...
        'href' => $this->url->link('account/vendor/lts_category')
    );

    $data['add'] = $this->url->link('account/vendor/lts_category/add');
    $data['delete'] = $this->url->link('account/vendor/lts_category/delete');
    $data['repair'] = $this->url->link('account/vendor/lts_category/repair');
  ...
  $filter_data = array(
    ...
    $results = $this->model_account_vendor_lts_category->getCategories($filter_data);
   
    foreach ($results as $result) {
      $data['categories'][] = array(
          'category_id' => $result['category_id'],
          'name' => $result['name'],
          'status' => $result['approved'] ? $this->language->get('text_approved') : $this->language->get('text_pending'),
          'sort_order' => $result['sort_order'],
          'edit' => $this->url->link('account/vendor/lts_category/edit', '&category_id=' . $result['category_id']),
      );
    }
    ...
    $data['sort_name'] = $this->url->link('account/vendor/lts_category');
    $data['sort_sort_order'] = $this->url->link('account/vendor/lts_category');
    ...
    $pagination->url = $this->url->link('account/vendor/lts_category', '&page={page}');
  ...
  protected function getForm() {
    ...
    if (!isset($this->request->get['category_id'])) {
      $data['action'] = $this->url->link('account/vendor/lts_category/add');
    } else {
      $data['action'] = $this->url->link('account/vendor/lts_category/edit', '&category_id=' . $this->request->get['category_id']);
    }

    $data['cancel'] = $this->url->link('account/vendor/lts_category');
